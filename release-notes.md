...
: Version 1.9.0 of the [{{site.data.keyword.powerSys_notm}} for SAP HANA](https://cloud.ibm.com/catalog/architecture/deploy-arch-ibm-pvs-sap-9aa6135e-75d5-467e-9f4a-ac2a21c069b8-global){: external} deployable architecture is available in the {{site.data.keyword.cloud_notm}} [catalog](/catalog#reference_architecture){: external}.
    - Upgrade `tok04`, `osa21` and `syd05` DCs to PER. New deployments in these regions will make use of PER.
...
[Warning]{: tag-red}
: Version 1.9.0 includes backward-incompatible changes for Sao Paulo 01 `tok04`, `osa21` and `syd05`  DC only. 
    - Do not upgrade to this version if previous deployments were made in `tok04`, `osa21` and `syd05` {{site.data.keyword.powerSys_notm}} zones as doing so will corrupt the landscape because of switch from Cloud connections to PER.
    - Use this for new deployments in `tok04`, `osa21` and `syd05` {{site.data.keyword.powerSys_notm}} zones.
